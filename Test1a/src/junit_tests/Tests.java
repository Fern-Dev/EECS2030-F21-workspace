...
public class Tests {
	...
	@Test
	public void test_assessment_01() { 
		/* 
		...
		Assessment m2 = new Assessment("Midterm 1", 0.254736);
		assertEquals("Assessment created: Midterm 1 accounts for 25.474 percents of the course.", m2.toString());
	}
