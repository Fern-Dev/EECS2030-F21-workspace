...
public class TestProduct {
	...
	public void test_product_1() {
		...
		assertEquals(0, p.getStorage()); // Expected, Actual
		...
		assertEquals(0.0, p.getOriginalPrice(), 0.1); // Tolerance +/- 0.1
		//		assertTrue(0.0 == p.getOriginalPrice()); // not good practice
	...
	public void test_product_2() {
		...
		//		assertTrue(p.getModel() == "iPad Pro 12.9"); // only compares address'
		...
		assertEquals(1709.00, p.getOriginalPrice(), 0.1); // Tolerance +/- 0.1
		//		assertTrue(1709.00 == p.getOriginalPrice()); // not good practice
		assertEquals(0.0, p.getDiscountValue(), 0.1);
	...
	public void test_product_3() {
		...
		p.setStorage(1000); // 1 TB
		assertTrue(p.getStorage() == 1000);
		assertEquals(1000, p.getStorage()); // Expected, Actual
